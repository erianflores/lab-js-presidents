...
function getNames(presidentsArr) {
  const newArray1 = presidentsArr.map((onePresident) => {
...
console.log("Democratic Presidents:", getDemocraticPresidents(presidents));
...
function sortPresidentsByBirthYear(presidentsArr) {
  presidentsArr.sort((a, b) => {
    if (a.birthYear > b.deathYear) {
      return -1;
    } else if (a.birthYear < b.deathYear) {
      return 1;
    } else {
      return 0;
    }
